...
- Primary run command: `<PRIMARY_RUN_COMMAND>`
...
- `<OPTIONAL_PROJECT_DOCUMENTATION>` — replace with relevant project-specific documents or remove this line when none exist.
...
- `<PROJECT_SPECIFIC_INSTRUCTION_OR_REMOVE_THIS_LINE>`
